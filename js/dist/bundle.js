...
var handleDataResultsNext = function handleDataResultsNext(results, values) {
  ...
  var currNow = new Date().getTime();
  var currHours = new Date(currNow);
  var hours = currHours.getHours() + 4;
...
var drawHtml = function drawHtml(arr, arr2) {
  for (var l = 0; l < arr.length && arr2.length; l++) {
    ...
    var currentTime1 = arr2[l].hours;
    var hours = currentTime1;
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(49), __webpack_require__(336).setImmediate))
